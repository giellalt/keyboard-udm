.. -*- mode: rst -*-
==========================================
 Keyboards for the Udmurt language
==========================================

This directory contains source files and build instructions for developing
keyboards for the Udmurt language. The data and implementations
...
* http://giellatekno.uit.no/udmdoc/index.html
* https://giellalt.uit.no/tools/docu-udm-manual.html
...
The Udmurt keyboard sources can be acquired using the `Giella SVN
